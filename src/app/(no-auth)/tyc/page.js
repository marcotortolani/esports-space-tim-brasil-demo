...
export default async function Page() {
  return (
    <main
      className={` relative z-20 mt-40 md:mb-28 md:mt-40 w-full max-w-screen-xl overflow-y-hidden h-full min-h-screen px-6 py-12 bg-White text-Black flex flex-col items-center gap-4 md:rounded-xl`}
    >
      <div className=" relative w-full flex flex-col items-center gap-8">
        <section className="w-full flex flex-col gap-4">
          ...
          <ParagraphStyled>
            ...
            serviço denominado “{dictionary['site']}” (doravante o “Serviço” ou
            a “Opção de entretenimento”) oferecido por MOOB MEDIA BUSINESS, C.A
            (o “Prestador”), por meio do qual os usuários da Empresa Operadora
            S.A. – (doravante a “Operadora”) poderão acessar, a partir de seu
            dispositivo móvel, Tablet, laptop ou PC, conteúdo dedicado ao mundo
            das viagens, vídeos exclusivos de receitas, cultura e paladar,
            correspondentes, dicas de viagem e notas editoriais.
          </ParagraphStyled>
        </section>
        <section className=" w-full flex flex-col gap-4">
          ...
          <ParagraphStyled>
            Nesse sentido, todos os clientes da Operadora que desejarem poderão
            assinar, solicitando sua adesão à opção de entretenimento através do
            envio de um SMS com o comando que for considerado válido para tal
            ação para o número 111 (o preço da mensagem é equivalente a uma
            mensagem de texto por uso).
          </ParagraphStyled>
          <ParagraphStyled>
            Ao enviar a palavra{' '}
            ...
            , o cliente receberá um SMS com o link e as instruções de acesso ao
            portal, o preço do serviço, a frequência de cobrança e um PIN para
            acessar a opção de entretenimento. Após o acesso, poderá desfrutar
            ilimitadamente de todo o conteúdo que oferece {dictionary['site']}.
            Os encargos por navegação e transmissão de dados não estão incluídos
            no serviço. Os usuários também poderão assinar por meio do website
            da Operadora, na seção de opções de entretenimento digital,
            selecionando a opção “{dictionary['site']}
            ”, através da URL própria do serviço{' '}
            <Link
              className=" text-sky-600 "
              target="_blank"
              href="www.esportsspace.moob.club"
            >
              www.esportsspace.moob.club
            </Link>{' '}
          ...
          <ParagraphStyled>
            ...
            menos uma vez por mês. Adicionalmente, {dictionary['site']} enviará
            ao usuário mensagens de texto com informações relevantes nos
            períodos em que forem realizados sorteios, premiações e/ou
          ...
          <ParagraphStyled>
            ...
            cliente assina o serviço. Serão também aplicáveis todas as condições
            particulares, avisos ou instruções de funcionamento que forem
            informadas ao usuário através do website da Operadora ou do
        ...
        <section className=" w-full flex flex-col gap-4">
          ...
          <ParagraphStyled>
            ...
            colocando ênfase especial nos direitos de propriedade intelectual e
            industrial, e abster-se de utilizar o “Serviço” com fins ilícitos ou
            de forma que atente ou viole direitos de terceiros ou do Prestador.
            Os Usuários serão os exclusivos responsáveis pelos danos ou
            prejuízos de qualquer natureza que possam derivar-se do uso
          ...
          <ParagraphStyled>
            ...
            utilizado pelos Usuários apenas na medida permitida por estes Termos
            e Condições e pela legislação aplicável.
          </ParagraphStyled>
          <ParagraphStyled>
            A menos que seja expressamente especificado o contrário, o conteúdo
            não poderá ser baixado para os dispositivos dos usuários.
          </ParagraphStyled>
        </section>
        <section className=" w-full flex flex-col gap-4">
          ...
          <ParagraphStyled>
            ...
            recebimento de mensagens de texto relacionadas à “Assinatura” serão
            de responsabilidade do titular do número móvel utilizado para tal
            fim, e não poderão ser opostas por{' '}
          ...
          <ParagraphStyled>
            ...
            por nenhum dano ou prejuízo causado ou que possa ser causado aos
            Usuários ou a terceiros, em suas pessoas ou bens, pela contratação
            ou utilização do “Serviço”. Também não serão responsáveis em caso de
            insatisfação com o conteúdo do serviço. Nestes casos, os usuários
            serão livres para cancelar, enviando a palavra{' '}
            <span className=" font-semibold">BAJA ao número 111</span>.
          </ParagraphStyled>
          <ParagraphStyled>
            ...
            tecnológica do Prestador nem por atrasos que possam ocorrer nas
            visualizações de conteúdo, mensagens de texto ou qualquer outro
            envio relacionado à “Assinatura”, por qualquer causa não imputável
            ao Prestador, incluindo, mas sem se limitar a, falhas na
            conectividade da rede, excesso ou saturação do tráfego da rede, e/ou
            qualquer característica dos telefones móveis que impeça a
            transmissão de tais envios ou solicitações.
          </ParagraphStyled>
          <ParagraphStyled>
            O Prestador reserva-se o direito de efetuar, sem aviso prévio, todo
            tipo de modificação na mecânica da “Assinatura” com o único
        ...
        <section className=" w-full flex flex-col gap-4">
          ...
          <ParagraphStyled>
            ...
            Usuários e o Prestador será regida e concertada em total sujeição às
            leis do País da Operadora, renunciando os Usuários a qualquer
            outra lei à cuja aplicação possa ter direito.
          </ParagraphStyled>
          <ParagraphStyled>
            Estes Termos e Condições são regidos pela lei do País da
            Operadora. Para qualquer controvérsia que possa derivar da
            prestação dos “Serviços” ou da interpretação e aplicação dos Termos
            e Condições, o Prestador e os Usuários aceitam submeter-se aos
            tribunais competentes do País da Operadora com expressa renúncia
            a qualquer outro foro ou jurisdição que lhes possa corresponder.
          </ParagraphStyled>
        </section>
      </div>
    </main>
...
const TitleStyled = ({ children }) => (
  <h1
    className={
      ' w-full uppercase font-druk tracking-widesrt pointer-events-none cursor-default text-[1.8rem] leading-[2rem] md:text-3xl lg:text-5xl text-Black text-left  '
    }
  >
    {children}
  </h1>
...
const Title2Styled = ({ children }) => (
  <h2
    className={` w-full md:max-w-full font-druk uppercase  text-Black text-xl md:text-lg lg:text-3xl`}
  >
    {children}
  </h2>
)
