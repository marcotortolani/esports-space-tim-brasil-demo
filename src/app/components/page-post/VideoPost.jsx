...
export default async function VideoPost({ dataVideo, vimeoNumber, children }) {
  ...
  return (
    <main
      className={`z-20 mt-24 md:mb-10 md:mt-24 lg:mt-16 w-screen max-w-screen-xl h-full min-h-screen px-6 pt-6 bg-White text-Black flex flex-col items-center gap-4 md:rounded-xl`}
    >
      <div className="z-50 top-0 m-2 mb-5 md:mb-2 right-0 w-full lg:max-w-4xl h-10 flex items-center justify-between">
      ...
      <section className=" w-full lg:max-w-4xl flex flex-col items-center gap-4">
        <h1
          className={
            ' w-full uppercase font-druk pointer-events-none cursor-default text-[1.8rem] leading-[2rem] md:text-3xl lg:text-4xl text-Black text-left  '
          }
        >
      ...
      {children}
      <div className="w-full h-28 md:h-20 "></div>
    </main>
  )
}
